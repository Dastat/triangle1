...
public class TriangleSidesAngle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_triangle.setImageResource(R.drawable.main_img_triangle_sides_angle);//заменяем на нужную картинку
        ...
        corner.setText(R.string.corner_sigma);//меняем на нужный  текст
        ...
        btn_back_cal1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(TriangleSidesAngle.this, TriangleSelect.class);//намеренье перейки из одного окна в другое
    ...
    public void calculate (View view)   {
        ...
        final EditText corner3= (EditText)findViewById(R.id.edit_3);//находим стороку для ввода данных. Угол сигмма в градусах (Известно)
        ...
        double gamma = Float.parseFloat(corner3.getText().toString());//преобразовываем введеную паеременную в число
        ...
        double res = side_a*side_b*sinGamma/2;//формула для вычисления полощади
    ...
    public void onBackPressed() {
        try{
            Intent intent = new Intent(TriangleSidesAngle.this, TriangleSelect.class);//намеренье перейти из одного окна в другое
