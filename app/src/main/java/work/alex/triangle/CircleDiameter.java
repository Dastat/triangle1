...
//площадь кркга через диаметр
public class CircleDiameter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_triangle.setImageResource(R.drawable.main_img_circle_diameter);//заменяем на нужную картинку
        ...
        side1.setText(R.string.diameter_D);//меняем на нужный  текст
        ...
        btn_back_cal1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(CircleDiameter.this, CircleSelect.class);//намеренье перейки из одного окна в другое
    ...
    public void calculate (View view)   {
        ...
        final double diameter = Float.parseFloat(num1.getText().toString());//преобразовываем введеную паеременную в число

        double res = (PI*pow(diameter,2)/4);//формула для вычисления полощади
        ...
        double radius = diameter/2;//находим неизвестную сторону через теорему косинусов
    ...
    public void onBackPressed() {
        try{
            Intent intent = new Intent(CircleDiameter.this, SquareSelect.class);//намеренье перейти из одного окна в другое
