...
//площадь прямоуголькика  через сторону и диагональ
public class SquareSideDiagonal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_triangle.setImageResource(R.drawable.main_img_square_side_diagonal);//заменяем на нужную картинку
        ...
        side2.setText(R.string.diagonal);//меняем на нужный  текст
        ...
        btn_back_cal1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(SquareSideDiagonal.this, SquareSelect.class);//намеренье перейки из одного окна в другое
    ...
    public void calculate (View view)   {
        ...
        final double diagonal = Float.parseFloat(num2.getText().toString());//преобразовываем введеную паеременную в число
        final double side_b = sqrt(pow(diagonal,2)-pow(side_a,2));
    ...
    public void onBackPressed() {
        try{
            Intent intent = new Intent(SquareSideDiagonal.this, SquareSelect.class);//намеренье перейти из одного окна в другое
