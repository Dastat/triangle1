...
//площадь круга через длинну окружности
public class CircleСircumference extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_triangle.setImageResource(R.drawable.main_img_circle_circumference);//заменяем на нужную картинку
        ...
        side1.setText(R.string.circumference);//меняем на нужный  текст
        ...
        btn_back_cal1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    Intent intent = new Intent(CircleСircumference.this, CircleSelect.class);//намеренье перейки из одного окна в другое
    ...
    public void calculate (View view)   {
        ...
        final double L = Float.parseFloat(num1.getText().toString());//преобразовываем введеную паеременную в число

        double res = pow(L,2)/(4*PI);//формула для вычисления полощади
        ...
        double diameter = L/PI;//находим неизвестную сторону через теорему косинусов
    ...
    public void onBackPressed() {
        try{
            Intent intent = new Intent(CircleСircumference.this, SquareSelect.class);//намеренье перейти из одного окна в другое
